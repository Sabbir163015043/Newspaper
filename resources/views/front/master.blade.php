                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="tb-contact">
                            <p><i class="fas fa-envelope"></i>sabbirhossain.tct94@gmail.com</p>
                            <p><i class="fas fa-phone-alt"></i>+8801706735774</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="tb-menu">
                    ...
                    <div class="col-lg-6 col-md-4">
                        <div class="b-ads">
                            <a href="https://htmlcodex.com">
                                <img src="{{ asset('/') }}front/img/cover.png" alt="Ads">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4">
                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto" >
                            <a href="{{ route('/')}}"  class="nav-item nav-link active">হোম</a>
                            @foreach($categories as $key => $category)
                            <a href="{{ route('single-page',['id' => $category->id]) }}" class="nav-item nav-link">{{ $category->name }}</a>
                            @endforeach
                        </div>
